...
int  read_from_science_buffer(sm_t *sm_p, scievent_t *science_p, int id);
int  read_newest_science_buffer(sm_t *sm_p, scievent_t *science_p, int id);
int  write_to_science_buffer(sm_t *sm_p, scievent_t *science_p);
