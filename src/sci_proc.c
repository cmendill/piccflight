...
int sci_phase_merit(double x[], double *f, double g[], void *params){
#endif
  ...
  *f = merit;
  ...
  if(opt_param->calc_derivative){
    memcpy(&dir_param,opt_param,sizeof(opt_param_t));
    dir_param.calc_derivative=0;
