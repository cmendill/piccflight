...
#define SCI_PHASE_N_ZERNIKE_DEFAULT 7
...
#define SHK_GAIN_ALP_CELL_SI_DEFAULT {      -0.1,      -0.5,       0.0}
#define SHK_GAIN_ALP_CELL_DI_DEFAULT {      -0.5,      -0.05,      0.0}
#define SHK_GAIN_ALP_ZERN_SI_DEFAULT {				         \
...
#define SHK_GAIN_ALP_ZERN_DI_DEFAULT {					\
...
#define LYT_GAIN_ALP_ZERN_SI_DEFAULT {				         \
                                     {-0.100000,  -0.600000,       0.0}, \
				     {-0.100000,  -0.600000,       0.0}, \
				     {-0.100000,  -0.600000,       0.0}, \
				     {-0.010000,  -0.050000,       0.0}, \
				     {-0.010000,  -0.050000,       0.0}, \
				     {-0.010000,  -0.050000,       0.0}, \
				     {-0.010000,  -0.050000,       0.0}, \
				     {-0.010000,  -0.050000,       0.0}, \
...
//Lyot LOWFS Gains                      P           I            D
#define LYT_GAIN_ALP_ZERN_DI_DEFAULT {				         \
